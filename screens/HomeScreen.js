...
const notifications = [
  ...
  { id: '3', message: 'New assignment posted for Algoritmebis sawyisebi.', date: '2024-10-06' },
  { id: '4', message: 'New assignment posted for Algoritmebis sawyisebi.', date: '2024-10-06' },
  { id: '5', message: 'New assignment posted for Algoritmebis sawyisebi.', date: '2024-10-06' },
  { id: '6', message: 'New assignment posted for Algoritmebis sawyisebi.', date: '2024-10-06' },
  { id: '7', message: 'New assignment posted for Algoritmebis sawyisebi.', date: '2024-10-06' },
  { id: '8', message: 'New assignment posted for Algoritmebis sawyisebi.', date: '2024-10-06' },
  { id: '9', message: 'New assignment posted for Algoritmebis sawyisebi.', date: '2024-10-06' },
  { id: '10', message: 'New assignment posted for Algoritmebis sawyisebi.', date: '2024-10-06' },
  { id: '11', message: 'New assignment posted for Algoritmebis sawyisebi.', date: '2024-10-06' },
];
                ...
                >
                  ...
                  {subjects.slice(-3).map(subject => ( 
                    <View key={subject.id} style={styles.itemContainer}>
                      ...
                      <Text style={styles.secondaryText}>{`Score: ${subject.score}`}</Text>
                    </View>
                  ))}
                </LinearGradient>
              </TouchableWithoutFeedback>
                ...
                >
                  ...
                  {assignments.slice(-3).map(assignment => ( 
                    <View key={assignment.id} style={styles.itemContainer}>
                      ...
                      <Text style={styles.secondaryText}>{`Due: ${assignment.dueDate}`}</Text>
                    </View>
                  ))}
                </LinearGradient>
              </TouchableWithoutFeedback>
                ...
                >
                  ...
                  {notifications.slice(-3).map(notification => ( 
                    <View key={notification.id} style={styles.itemContainer}>
                      ...
                      <Text style={styles.secondaryText}>{`Date: ${notification.date}`}</Text>
                    </View>
                  ))}
                </LinearGradient>
              </TouchableWithoutFeedback>
              ...
              <View style={styles.modalContainer}>
                <View style={[styles.modalContent, { maxHeight: height * 0.7 }]}>
                  <Text style={styles.modalSubtitle}>
                    {type === 'subjects' ? 'Subjects and Scores' :
                     type === 'assignments' ? 'Assignments and Due Dates' : 'Your Notifications'}
                  </Text>
                  <FlatList
                    data={type === 'subjects' ? subjects : type === 'assignments' ? assignments : notifications}
